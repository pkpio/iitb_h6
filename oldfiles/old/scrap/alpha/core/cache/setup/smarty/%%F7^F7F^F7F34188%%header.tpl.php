...
<head>
 ...
 <?php echo $this->_tpl_vars['app_version']; ?>
 &raquo; <?php echo $this->_tpl_vars['_lang']['install']; ?>
</title>
    ...
    <?php if ($this->_tpl_vars['_lang']['additional_css'] != ''): ?>
    <style type="text/css"><?php echo $this->_tpl_vars['_lang']['additional_css']; ?>
</style>
    <?php endif; ?>
    ...
    <div class="container_12">
        <div id="metaheader">
            <div id="metanav" class="grid_9">
               <ul>
                    <li><a href="#"><strong><?php echo $this->_tpl_vars['app_name']; ?>
</strong>&nbsp;<em><?php echo $this->_tpl_vars['_lang']['version']; ?>
 <?php echo $this->_tpl_vars['app_version']; ?>
</em></a></li>
               </ul>
            </div>
